...
public class HistoryTaskApi {
    ...
    public HistoryTaskApi(Service processHistory) {
    ...
    public List<HistoryTask> getHistoryTasks() {
        log.info("Retrieve a list of historical data of tasks");
        ...
        return Arrays.asList(
                given()
                        ...
                        .extract().as(HistoryTask[].class));
    }

    public ErrorResponse getHistoryTasksInvalidParam(Map<String, ?> parametersMap, int statusCode) {
        return given()
                .spec(requestSpec)
    ...
    public ErrorResponse getHistoryTasks(int statusCode) {
        log.info("Getting a list of historical data of tasks should return error with status: {}", statusCode);
        return given()
                .spec(requestSpec)
                .get("/tasks")
                .then()
